<template>
    <form class="max-w-md mx-auto text-white border border-solid border-gray-700 rounded-lg p-8 my-8 flex flex-col justify-center" @submit.prevent="useStudent.addStudent">
        ...
        <div class="relative z-0 w-full mb-5 group">
            <input type="text" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none :text-white :focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " :v-model="useStudent?.$state?.student?.father_number" required />
        ...
        <div class="relative z-0 w-full mb-5 group">
            <input type="text" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none :text-white :focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " :v-model="useStudent?.$state?.student?.mother_number" required />
        ...
        <select id="countries" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" :v-model="useStudent?.$state?.student?.branch">
        ...
        <div class="grid md:grid-cols-2 md:gap-6 my-4">
            <div class="relative z-0 w-full mb-5 group">
                <input type="date" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  :focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600" placeholder="" :v-model="useStudent?.$state?.student?.student_birthdate" required />
