<template>
     <div class="flex flex-col items-center justify-center w-full">
        ...
        <div class="object-cover mx-auto w-96 overflow-hidden">
            <img  v-if="useStudent.$state.student.student_id_photo" :src="useStudent.$state.student.student_id_photo" alt="تحميل الصورة" class="mt-4 max-w-xs mx-auto border border-gray-300 rounded-lg w-80 h-40" />
        </div>
    </div>
</template>
