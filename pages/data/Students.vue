<template>
          ...
          <tbody v-if="useStudent.$state.students">
             <tr  v-for="student in useStudent.$state.students" :key="student.id" class="bg-white dark:bg-gray-800 transition-all duration-100 text-[12px] xl:text-[16px]">
                ...
                <td class="px-6 py-4 flex justify-center items-center">
                  <img v-if="student.student_id_photo" :src="student.student_id_photo" class="h-12 w-12 border border-solid border-black rounded-lg" @click="setImage(student.student_id_photo)" />
    ...
    <!-- <ImageModal  :img="openedImage" :isOpen="isOpen"  /> -->
