            ...
            <div class="bg-white p-8 rounded shadow-lg flex flex-col h-[27rem]">
                ...
                <div class="flex justify-center items-center mb-4">
                    ...
                    <button
                        ...
                        class="px-6 py-2 rounded-r-lg focus:outline-none transition-all duration-100" @click="setActiveTab('حساب جديد')">SignUp</button>
                </div>
...
// Method to toggle between login and sign-up tabs
